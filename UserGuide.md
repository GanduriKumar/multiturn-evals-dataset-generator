...
- **Golden dataset** → Expected response variants and policy decision per conversation.
...
Naming rule:
- If you select **all** workflows, behaviours, and scenario values, the name starts with `combined`.
- Otherwise, the name includes a short summary of the selected workflows, behaviours, and scenarios.
...
You’ll need (legacy scoring format):
